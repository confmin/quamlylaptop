...
<div class="Phan2Phai">
    ...
    <div class="container" style="margin-top: 20px;margin-left:5px;">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php 
                  $result = $db->conn->query('SELECT count(MaTinTuc) as total from tintuc');
                  ...
                  $current_page = isset($_GET['page']) ? $_GET['page'] : 1;
                      ...
                      $result = $db->conn->query( "SELECT tintuc.MaTinTuc, tintuc.AnhTinTuc, tintuc.TenTinTuc,danhmuctintuc.TenDMTT, tintuc.MoTa, tintuc.ChiTiet, tintuc.TinTucNong FROM tintuc INNER JOIN danhmuctintuc ON danhmuctintuc.MaDMTT=tintuc.MaDMTT LIMIT $start, $limit");
