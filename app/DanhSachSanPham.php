...
<div class="Phan2Phai">
    ...
    <div class="container" style="margin-top: 20px;margin-left:5px;">
        ...
        <table class="table table-hover">
            ...
            <tbody>
                <?php 
                  $result = $db->conn->query( 'SELECT count(MaSP) as total from sanpham');
                  ...
                  $current_page = isset($_GET['page']) ? $_GET['page'] : 1;
                      ...
                      $result = $db->conn->query( "SELECT MaSP, danhmucsanpham.TenDMSP, sanpham.AnhSP, sanpham.TenSP, sanpham.MoTa, sanpham.Gia, sanpham.Hot, sanpham.Sale FROM sanpham INNER JOIN danhmucsanpham ON danhmucsanpham.MaDMSP=sanpham.MaDMSP LIMIT $start, $limit");
